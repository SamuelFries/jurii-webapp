...
export default async function PaginaDoEscritorio() {
  ...
  const passos = passosDoEscritorio(estado);
          ...
          {pendencias > 0 && (
            <>
              ...
              {conversasParadas.slice(0, NA_VISAO).map((conversa) => (
                <Link
                  key={conversa.id}
                  href={`/escritorio/conversas/${conversa.id}`}
                  className="cartao-de-lista"
                >
                  <span className="conteudo">
              ...
              {pendencias > NA_VISAO && (
                <Link className="botao secundario compacto" href="/escritorio/casos">
        ...
        <aside className="coluna-lateral">
          ...
          <div className="cartao">
            <div className="linha-topo">
              ...
              <Link className="discreto" href="/escritorio/assinatura">
                Ver
              </Link>
            </div>
            {assinatura === null ? (
          ...
          <div className="cartao">
            <div className="linha-topo">
              ...
              <Link className="discreto" href="/escritorio/equipe">
                Ver
              </Link>
            </div>
            <p className="detalhe" style={{ marginTop: 6 }}>
