...
await sec.locator("a", { hasText: "Entrar para aceitar" }).click();
...
// Aceita e cai na casa nova.
await sec.locator("button", { hasText: "Aceitar convite" }).click();
await sec.waitForURL(/escritorio\/cf300000/, { timeout: 15000 });
confere("aceitou e entrou na area do escritorio", true, sec.url());
...
confere("o mesmo link para a SEGUNDA pessoa diz 'ja foi usado'", corpoIntruso.includes("já foi usado"), "");
